from data_access import load_offers_list, load_offer, add_comparison_record, load_comparisons, load_usernames, remove_comparison_record, save_cv_data
...
def display_page():
    ...
    user_data = display_user_form(username)
