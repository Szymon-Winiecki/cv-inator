...
import argparse
from data_access import load_usernames, load_cv_data
...
def generate_cv(template_path, username, offer_id, output_path):
    data = load_cv_data(username, offer_id)
...
if __name__ == "__main__":
    args = parse_args()
    generate_cv(args.template_path, args.cv_path, args.offer_id, args.output_path)
